#include "LobbiesListScreen.h"

void LobbiesListScreen::OnCreatePressed() {
...
void LobbiesListScreen::OnJoinLobbyPressed(int id) {
    audioPlayer.PlayButtonSFX();
...
void LobbiesListScreen::OnRefreshPressed() {
    audioPlayer.PlayButtonSFX();
...
void LobbiesListScreen::WaitRefresh() {
    LoadingScreen loading(
            cam, resource, wasClosed,
            [this]() {
...
void LobbiesListScreen::LoadWidgetList(std::vector<DataMatch> data) {
    widgets.clear();
...
void LobbiesListScreen::UpdateWidgetListPosition(Vector2D movement) {
...
void LobbiesListScreen::InitHeader() {
...
void LobbiesListScreen::InitControlsButton() {
...
void LobbiesListScreen::InitCreateButton() {
...
void LobbiesListScreen::InitRefreshButton() {
...
LobbiesListScreen::LobbiesListScreen(Camera& cam, ResourceManager& resource, bool& wasClosed,
...
LobbiesListScreen::~LobbiesListScreen() = default;

void LobbiesListScreen::TakeInput(SDL_Event event) {
    switch (event.type) {
        case SDL_MOUSEWHEEL:
...
void LobbiesListScreen::InitRun() { WaitRefresh(); }

void LobbiesListScreen::Update([[maybe_unused]] float deltaTime) { guiManager.Draw(cam); }
