...
SpawnPointWidget::SpawnPointWidget(GUIManager& guiManager,
                                   CallbackParam<pair<Object2D, int>> onSelect, int _type,
    ...
    btn = guiManager.CreateButton(
            BUTTON_1_IMAGE,
            RectTransform(Transform(Vector2D(pos.x, pos.y), Vector2D(75, 40)), Vector2D(0.5, 1)),
