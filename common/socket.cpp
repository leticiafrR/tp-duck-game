...
// devuelve 0 si el socket se cerrò,
//  -1 si es un error,
//  caso contrario los bytes recibidos
...
// lanza una excepciòn si es un error
// devuelve 0 si el otro extremo dejò de escuchar (o estaba cerrado) y actualiza el estado de
// was_close si no hubo errores devuelve la cantidad de bytes enviados
...
/*
retorna 0 sino se recibieron los sz bytes y el socket se cerrò. Lanza una excepciòn si se recibiò
una parte)
retorna sz si es que logrò recibir todo
*/
