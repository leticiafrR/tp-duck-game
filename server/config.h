...
class Config {
    ...
    // cppcheck-suppress unusedStructMember
    std::vector<TypeCollectable> colectableTypes;
    // cppcheck-suppress unusedStructMember
    std::vector<TypeProjectile> projectileTypes;
    // cppcheck-suppress unusedStructMember
    ...
    void setCollectableTypes(const YAML::Node& config);
    void setProjectileTypes(const YAML::Node& config);
...
public:
    ...
    /************************Collectable TYPES******************************** */
    TypeCollectable getAK47CollectableType() const;
    TypeCollectable getSniperCollectableType() const;
    TypeCollectable getBananaCollectableType() const;
    TypeCollectable getGranadaCollectableType() const;
    TypeCollectable getLaserRifleCollectableType() const;
    TypeCollectable getCowboyPistolCollectableType() const;
    TypeCollectable getHelmetCollectableType() const;
    TypeCollectable getArmorCollectableType() const;
    TypeCollectable getEmptyCollectableType() const;
    TypeCollectable getDuelingPistolCollectableType() const;
    TypeCollectable getMagnumCollectableType() const;
    TypeCollectable getShotgunCollectableType() const;
    TypeProjectile getLaserProjectileType() const;
    TypeProjectile getBananaProjectileType() const;
    TypeProjectile getGranadaFragmentCollectableType() const;
    TypeProjectile getBulletProjectileType() const;
