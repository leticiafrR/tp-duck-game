...
// Projectiles
const std::string LASER_STR = "laser";
const std::string BULLET_STR = "bullet";
const std::string GRANADA_FRAGMENT_STR = "granada_fragment";
const std::string PROJECTILES_TYPES_STR = "projectiles_types";

const int LASER_INDEX = 1;
const int BULLET_INDEX = 2;
const int GRANADA_FRAGMENT_INDEX = 3;
